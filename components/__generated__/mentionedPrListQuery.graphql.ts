/**
 * @generated SignedSource<<31ddc05b2b3d4f7b96eb5e213f63fd41>>
...
export type mentionedPrListQuery$variables = Record<PropertyKey, never>;
export type mentionedPrListQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"mentionedPrList_search">;
};
export type mentionedPrListQuery = {
  response: mentionedPrListQuery$data;
  variables: mentionedPrListQuery$variables;
};
...
return {
    ...
    "selections": [
      {
        ...
        "storageKey": "search(first:10,query:\"-author:@me is:open is:pr -review-requested:@me mentions:@me sort:updated\",type:\"ISSUE\")"
      },
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "4a615672d1f65a4fc914a6bb3378f4de",
    "id": null,
    "metadata": {},
    "name": "mentionedPrListQuery",
    "operationKind": "query",
...
(node as any).hash = "75b7f5bb2f5db1cc44bc780ff1d1f67c";
